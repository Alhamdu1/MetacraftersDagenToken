...
contract DegenToken is ERC20, Ownable, ERC20Burnable {
    ...
    function showStoreItems() external pure returns (string memory) {
        ...
        console.log("Selection 1. Official Degen OG role");
        console.log("Selection 2. Degen NFT");
        console.log("Selection 3. Degen T-Shirt");
        return
            "The following items are available for purchase:\nSelection 1. Official Degen OG Role\nSelection 2. Official Degen NFT\nSelection 3. Official Degen T-Shirt";
    }
    ...
    function redeemTokens(uint8 _userChoice) external payable returns (bool) {
        if (_userChoice == 1) {
            ...
            console.log("You have redeemed for an official Degen OG Role");
            return true;
